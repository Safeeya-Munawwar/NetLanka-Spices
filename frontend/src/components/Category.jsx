        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {categories.map((cat) => (
            <Link
              key={cat.id}
              to={cat.link}
              className={`group flex flex-col justify-between h-48 p-6 rounded-lg shadow transition duration-300 ${cat.color} ${cat.hoverColor} hover:shadow-lg`}
            >
              {/* Top: icon + text */}
              ...
              {/* Bottom: arrow button aligned right */}
