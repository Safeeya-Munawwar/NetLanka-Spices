        ...
        <div className="grid md:grid-cols-3 gap-8 bg-[#f7f7f7] p-8 rounded-lg">
          {loadingServices ? (
            ...
            services.map((service) => (
              <div
                key={service.id}
                className="flex flex-col items-center text-center bg-white rounded-lg shadow-sm p-4"
              >
                <img
                ...
                />
                <h3 className="font-semibold text-lg mt-4 mb-2 text-[#4b2e05]">
                  {service.title}
                </h3>
                ...
                <button
                  ...
                  className="bg-[#4b2e05] text-white px-5 py-2 text-sm rounded font-semibold tracking-wide hover:bg-[#3a2404] transition-all"
                >
                  LEARN MORE
                </button>
              </div>
      ...
      <section className="relative py-16 px-6 md:px-40">
        ...
        <div className="relative grid md:grid-cols-2 gap-10 items-center z-10">
          ...
          <div className="p-4 md:p-10">
            ...
            <p className="text-[#3d2d11] mb-4 leading-relaxed text-[16px] text-justify">
            ...
            <p className="text-[#3d2d11] leading-relaxed text-[16px] text-justify">
