...
const categories = [
  { id: 1, name: "Herbs", icon: <FaLeaf size={40} />, slug: "herbs" },
  { id: 2, name: "Spices", icon: <FaSeedling size={40} />, slug: "spices" },
  { id: 3, name: "Teas", icon: <FaSpa size={40} />, slug: "teas" },
  { id: 4, name: "Coffee", icon: <FaCoffee size={40} />, slug: "coffee" },
];
